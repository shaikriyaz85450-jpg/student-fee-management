...
export function DashboardNavbar({
  ...
  const isAccountant = pathname.includes("/accountant")

  let resolvedName = studentName
  let resolvedEmail = studentEmail

  if (!resolvedName) {
    if (isStudent && currentStudent) {
      resolvedName = currentStudent.name
      resolvedEmail = resolvedEmail || currentStudent.email || "arjun.reddy@example.com"
    } else if (isFaculty) {
      resolvedName = "Prof. Suresh Kumar"
      resolvedEmail = resolvedEmail || "suresh.kumar@university.edu"
    } else if (isAccountant) {
      resolvedName = "Mr. Rajesh Iyer"
      resolvedEmail = resolvedEmail || "rajesh.iyer@university.edu"
    } else {
      resolvedName = "John Student"
      resolvedEmail = resolvedEmail || "john@student.edu"
    }
  }
  if (!resolvedEmail) {
    resolvedEmail = "john@student.edu"
  }
