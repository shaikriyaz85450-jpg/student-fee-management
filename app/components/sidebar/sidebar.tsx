          ...
          {collapsed ? (
            <Tooltip>
              <TooltipTrigger asChild>
                <button onClick={() => router.push('/student/login')} className="flex w-full items-center justify-center rounded-xl p-2.5 text-sidebar-foreground/70 transition-colors hover:bg-red-500/10 hover:text-red-500">
            ...
            <button onClick={() => router.push('/student/login')} className="flex w-full items-center gap-3 rounded-xl px-3 py-2.5 text-sm font-medium text-sidebar-foreground/70 transition-colors hover:bg-red-500/10 hover:text-red-500">
