  ...
  return (
    <div className="rounded-2xl border border-border bg-card p-6 shadow-sm transition-all duration-300 hover:shadow-md hover:border-primary/20">
      <div className="mb-6 flex items-center justify-between">
        <div>
          <h3 className="text-lg font-semibold text-foreground">All Students Fee Analytics</h3>
          <p className="text-sm text-muted-foreground">Paid and pending totals across all students</p>
        </div>
